...
function askForNumber() {
  ...
  while (numMeals > 6 || numMeals < 1 || !Number.isInteger(Number(numMeals))) {
    numMeals = input.question("How many meals would you like to make? (Please choose a number from 1-6): ");
  }
...
function generatePassword(string1, string2) {
  ...
  if (string1.length > string2.length) {
    largerLength = string1.length;
  } else {
    largerLength = string2.length;
  }
